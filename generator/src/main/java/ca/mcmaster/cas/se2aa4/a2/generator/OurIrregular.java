...
public class OurIrregular {
    ...
    private int num_of_polygons;

    public OurIrregular(int width, int height, int num_of_polygons){
        this.width = width;
        this.height = height;
        this.num_of_polygons = num_of_polygons;
    };
    ...
    public Mesh generate() {
        ...
        ArrayList<Coordinate> listCoordinates = generate_random_points(num_of_polygons);
